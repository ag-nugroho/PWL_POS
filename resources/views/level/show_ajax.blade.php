        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <table class="table table-sm table-bordered table-striped">
                    <table class="table table-sm table-bordered table-striped">
                        <tr><th class="test-right col-3">Kode Level : </th><td class="col-9">{{ $level->level_kode }}</td></tr>
                        <tr><th class="test-right col-3">Nama Level : </th><td class="col-9">{{ $level->level_nama }}</td></tr>
                    </table>
                </table>
            </div>
