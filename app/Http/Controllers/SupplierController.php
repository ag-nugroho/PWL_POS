...
class SupplierController extends Controller
{
    ...
    {
        // Ambil data dari tabel m_supplier dengan kolom supplier_id, supplier_kode, supplier_nama, supplier_alamat
        $suppliers = SupplierModel::select('supplier_id', 'supplier_kode', 'supplier_nama', 'supplier_alamat');
    
        // Jika ada filter berdasarkan supplier_id, tambahkan filter
    ...
    {
        $request->validate([
            'supplier_kode' => 'required|string|min:5|unique:m_supplier,supplier_kode',
    ...
    public function edit(string $id)
    {
        ...
        return view('supplier.edit', ['breadcrumb' => $breadcrumb, 'page' => $page, 'supplier' => $supplier, 'supplierList' => $supplierList, 'activeMenu' => $activeMenu]);
    ...
    public function destroy(string $id)
    {
        ...
        try {
            ...
            return redirect('/supplier')->with('error', 'Data supplier gagal dihapus karena masih terdapat tabel lain yang tekait dengan data ini');
        }
    }
    ...
    public function update_ajax(Request $request, $id){
        ...
        if($request->ajax() || $request->wantsJson()){
            $rules =[
                'supplier_kode' => 'required|string|min:5|unique:m_supplier,supplier_kode,'.$id.',supplier_id',
                'supplier_nama' => 'required|string|max:100',
                'supplier_alamat' => 'required|string|max:255'
            ];
