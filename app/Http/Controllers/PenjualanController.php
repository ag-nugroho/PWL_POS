    ...
    public function store_ajax(Request $request)
{
    ...
    public function show_ajax(string $id)
    {
        ...
        $detailpenjualan = DetailModel::where('penjualan_id', $id)->select('penjualan_id', 'barang_id', 'harga', 'jumlah')->get();
        $total_harga = DetailModel::where('penjualan_id', $id)->select(DB::raw('SUM(harga * jumlah) as total_harga'))->first()->total_harga;
